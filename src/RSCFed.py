...
if __name__ == "__main__":
    ...
    weight_path = '/nfs/home/wt_liyuting/Dec-SSL-main/save/05_11_2024_14_25_05_4131/model_best_0.66106_epoch58.pth'  # 替换为你的预训练权重路径
    ...
    for epoch in tqdm(range(start_epoch, total_epochs)):
        ...
        for idx in range(num_clients):
            ...
            # )
            w, loss, critical_parameter, global_mask, local_mask = local_model.update_semi_weights_align(
                lr=lr,
                # lr=args.lr,
                model=local_models[idx],
                global_round=epoch,
