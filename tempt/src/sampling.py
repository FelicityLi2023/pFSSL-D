...
def pathological_modify(dataset: List[tuple], client_number: int, seed: int) -> List[List[int]]:
    """
    Perform pathological non-IID sampling on the dataset.
    Each class of data is divided between two clients.
    ...
    # Divide each class between two clients
